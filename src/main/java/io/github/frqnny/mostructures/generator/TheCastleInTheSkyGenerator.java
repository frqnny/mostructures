...
public class TheCastleInTheSkyGenerator {
    ...
    public static final StructureProcessorList TCINS_ROT = RegUtils.registerStructureProcessor("tcins_rot", ImmutableList.of(new BlockRotStructureProcessor(0.25F)));
