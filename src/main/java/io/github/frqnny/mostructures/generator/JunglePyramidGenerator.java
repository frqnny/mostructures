...
public class JunglePyramidGenerator {
    ...
    public static final StructureProcessorList JUNGLE_ROT = RegistrationHelper.registerStructureProcessor("jungle_rot", ImmutableList.of(new BlockRotStructureProcessor(0.15F)));
