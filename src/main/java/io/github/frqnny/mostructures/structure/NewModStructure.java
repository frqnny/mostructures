...
public class NewModStructure extends Structure {
    public static final Codec<NewModStructure> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            ).apply(instance, NewModStructure::new));
    ...
    public NewModStructure(Structure.Config config, RegistryEntry<StructurePool> startPool, Optional<Identifier> startJigsawName, int size, HeightProvider startHeight, boolean useExpansionHack, Optional<Heightmap.Type> projectStartToHeightmap, int maxDistanceFromCenter, int heightRange) {
        super(config);
